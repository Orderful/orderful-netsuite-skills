...
| Dimension | Old | New |
|-----------|-----|-----|
| **People** | Contractor/SI vendors, OAs, AM handoff | Orderful product team + AM handoff |
...
Wrong outbound comm channel = outbound docs fail at delivery even though they pass validation. On Northwind Apparel, the outbound relationship was pointing to the wrong AS2 channel until it was re-pointed to the correct DSCO/Rithum AS2 channel. Always verify the channel matches the DSCO/Rithum AS2 destination before outbound testing.
